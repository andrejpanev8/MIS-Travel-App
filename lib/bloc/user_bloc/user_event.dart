...
class SaveOrUpdateTripEvent extends UserEvent {
  final Trip trip;

  const SaveOrUpdateTripEvent(this.trip);
}
...
class GetClientTripDetails extends UserEvent {
  final String tripId;

  const GetClientTripDetails({required this.tripId});
}