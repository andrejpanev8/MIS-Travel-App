...
Widget clientRideGeneralInfo(
    BuildContext context, Trip? trip, PassengerTrip? passengerTrip) {
  return (trip != null && passengerTrip != null)
    ...
    children: [
      ...
      SizedBox(height: 6),
      _buildRow(
          text: passengerTrip.user.phoneNumber, icon: Icons.phone_outlined),
      SizedBox(height: 20),
      _text(AppStrings.startLocation),
      SizedBox(height: 10),
      _buildRow(
          text: passengerTrip.startLocation.address ?? "No Location Provided", icon: Icons.location_on),
      SizedBox(height: 12),
      MapStatic(
      ...
      SizedBox(height: 10),
      _buildRow(text: passengerTrip.endLocation.address ?? "No Location provided", icon: Icons.location_on),
      SizedBox(height: 12),
